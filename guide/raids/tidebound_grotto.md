...
<div id="accordion">
<div class="card">
<div class="card-header" id="nymrissa">
<div data-toggle="collapse" data-target="#nymrissa-collapse" aria-expanded="true" aria-controls="nymrissa-collapse" class="raid-header tidebound_grotto1"><h2 style="margin-top: 30px;">Nymrissa Wavecaller</h2></div>
</div>
<div id="nymrissa-collapse" class="collapse" aria-labelledby="nymrissa" data-parent="#accordion">
...
<iframe src="https://raidbots.com/simbot/render/talents/CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMbbzMGjZZbZMmhBAAAAsYmNYADY2YCZWAgZbmZGzstMTYmBLmZmxMDLzMLzYMzsAAMMAmZMMMA?width=575&hideHeader=1&flush=1" frameborder="0" width="575px" height="100%" style="margin-left: 30px;">
</iframe>
</div>
...
#### Damage:
* Use {{ site.data.spell.sk }} to focus down {{ site.data.raid.tidebound_grotto.bubblefin_shorerunner }} but especially {{ site.data.raid.tidebound_grotto.bubblefin_frostscale }} [Mythic-only] whenever they are active.
* Use {{ site.data.spell.swg }} and {{ site.data.spell.gow }} to maintain uptime while dropping {{ site.data.raid.tidebound_grotto.drifting_globules }} or dodging {{ site.data.raid.tidebound_grotto.water_jet }} or {{ site.data.raid.tidebound_grotto.unending_tides }}.

#### Defensives:
* Use {{ site.data.spell.as }} for overlaps of {{ site.data.raid.tidebound_grotto.drifting_globules }} and {{ site.data.raid.tidebound_grotto.abyssal_rain }} but especially after accumulating multiple stacks of {{ site.data.raid.tidebound_grotto.drenched }}.
* Use {{ site.data.spell.healing_surge }} as needed and utilize {{ site.data.spell.hst }} as a movement filler.

#### Utilities:
* Use {{ site.data.spell.wrt }} to help players reposition while dropping {{ site.data.raid.tidebound_grotto.drifting_globules }}.
* Use {{ site.data.spell.earthgrab_totem }} and {{ site.data.spell.capacitor_totem }} to prevent adds from reaching {{ site.data.raid.tidebound_grotto.alluring_bubble }}.
* Use {{ site.data.spell.hex }} to control isolated {{ site.data.raid.tidebound_grotto.bubblefin_shorerunner }}.
